...
export default function (props) {
    return (
        <svg width='444' height='444' fill='none' xmlns='http://www.w3.org/2000/svg'>
            <circle cx='234' cy='217' r='175' fill='#09B239' filter='url(#filter0_d)'
            />
            ...
            <circle cx='233.5' cy='216.5' r='39.5' fill='#03A600' stroke='#379001'
                    strokeWidth='10' />
            <defs>
                <filter id='filter0_d' x='0' y='0' width='444' height='444' filterUnits='userSpaceOnUse'
                    ...
                    <feColorMatrix values='0 0 0 0 0.241356 0 0 0 0 0.646288 0 0 0 0 0.0508 0 0 0 1 0'
                    />
