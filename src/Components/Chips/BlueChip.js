...
export default function (props) {
    return (
        <svg width='444' height='444' fill='none' xmlns='http://www.w3.org/2000/svg'>
            <circle cx='234' cy='217' r='175' fill='#2C8BD0' filter='url(#filter0_d)'
            />
            ...
            <circle cx='233.5' cy='216.5' r='39.5' fill='#F5F5F5' fillOpacity='0.42'
                    stroke='#32769C' strokeWidth='10' />
            <defs>
                <filter id='filter0_d' x='0' y='0' width='444' height='444' filterUnits='userSpaceOnUse'
                    ...
                    <feColorMatrix values='0 0 0 0 0.143399 0 0 0 0 0.56542 0 0 0 0 0.69869 0 0 0 1 0'
                    />
